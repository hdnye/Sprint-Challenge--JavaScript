...
//       universities.sort ({
//         univerisity: element.university
//  })
//  return [];
// });
...
zooAnimals.map(element => {
  displayNames.push ({
    ...
    return `Name: ${element.name}, Scientific: ${element.scientific_name}`;
});
...
*/
const lowPopulationAnimals = zooAnimals.reduce(function(accumulator, currentItem) {
  return accumulator + currentItem.population < 5;
});
